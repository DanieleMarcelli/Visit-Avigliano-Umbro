        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.location.href='/'}>
            <div className="w-10 h-10 bg-brand-900 rounded-full flex items-center justify-center text-white overflow-hidden shadow-md">
                <img src={content.logoUrl} alt="Logo" className="w-full h-full object-cover opacity-90" />
            </div>
            <div className="flex flex-col">
              <span className="text-xs uppercase tracking-widest text-brand-900 font-bold">{content.subtitle}</span>
              <span className="text-xl font-bold font-serif leading-none text-stone-900">{content.title}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="hidden sm:flex items-center gap-2 text-stone-600 hover:text-brand-900 px-3 py-1.5 border border-stone-300 rounded-full text-sm font-medium transition-colors">
              <Share2 size={16} />
              <span className="hidden lg:inline">{content.shareLabel}</span>
            </button>
            ...
            <div className="hidden md:flex items-center justify-center w-10 h-10 bg-brand-900 text-white rounded-full cursor-pointer hover:bg-brand-800 transition-colors shadow-md" title={content.languageLabel}>
                <Globe size={18} />
            </div>
          </div>
        </div>
